...
public partial class T_DRAW_ADDITIONAL_GAME
{
    ...
    public string JOKER_PLUS_NUMBER { get; set; } = null!;

    public string MY_MILLION_NUMBER { get; set; } = null!;

    public string EXCEPTIONAL_EURO_MILLIONS_DRAW_NUMBER { get; set; } = null!;
