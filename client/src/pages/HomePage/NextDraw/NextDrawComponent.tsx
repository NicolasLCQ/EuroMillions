...
const formatJackpotAmount = (estimatedJackpot: IFdjMoneyAmount) => new Intl.NumberFormat("fr-FR", {
...
const formatDrawDate = (drawDate: Date) => new Intl.DateTimeFormat("en-GB", {
	weekday: "long",
	day: "numeric",
	month: "long",
	year: "numeric",
