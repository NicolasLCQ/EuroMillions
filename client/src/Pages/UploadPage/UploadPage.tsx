...
function UploadPage() {
	...
	return (
		<div className="UploadPage">
			<TittleComponent className="Title">You can upload the files from FDJ EuroMillions on this page</TittleComponent>
			<TextComponent className="Informations">
				1 - Download Files from <a className="EuroMillionsLink" href="https://www.fdj.fr/jeux-de-tirage/euromillions-my-million/historique">FDJ EuroMillions Historique</a><br/>
